    ...
    <div class="rule-container">
        <li>
            <div
                ...
                "
            >
                <!-- bg-gradient-to-r hover:from-blue-500 hover:to-indigo-400 -->
                <dl
                    class="grid sm:block lg:grid xl:block grid-cols-2 grid-rows-2 items-center"
                >
                    <div>
                        <dt class="sr-only">Formula</dt>
                        <dd
                    ...
                    <div>
                        ...
                        <dd
                            class="group-hover:text-blue-200 text-sm font-medium sm:mb-4 lg:mb-0 xl:mb-4"
                        >
                            category
                        </dd>
                    </div>
